...
""" unit tests IBM Spectrum Virtualize Ansible module: ibm_svc_volume_clone """
...
from ansible_collections.ibm.spectrum_virtualize.plugins.modules.ibm_svc_volume_clone import IBMSVCClone
...
class TestIBMSVCClone(unittest.TestCase):
    ...
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.get_fc_mapping')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.flashcopymap_probe')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.module_utils.'
           'ibm_svc_utils.IBMSVCRestApi._svc_authorize')
    ...
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.get_fc_mapping')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.flashcopymap_create')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.module_utils.'
           'ibm_svc_utils.IBMSVCRestApi._svc_authorize')
    ...
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.get_fc_mapping')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.modules.'
           'ibm_svc_volume_clone.IBMSVCClone.flashcopymap_delete')
    @patch('ansible_collections.ibm.spectrum_virtualize.plugins.module_utils.'
           'ibm_svc_utils.IBMSVCRestApi._svc_authorize')
